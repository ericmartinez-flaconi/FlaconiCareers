(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,53290,e=>{"use strict";var t=e.i(34782),l=e.i(48667);function a({initialData:e}){let[a,i]=(0,l.useState)(!1);return(0,l.useEffect)(()=>{(async()=>{try{let e=await fetch("https://docs.google.com/spreadsheets/d/e/2PACX-1vS_placeholder_replace_me/pub?output=csv"),t=(await e.text()).split("\n").map(e=>e.split(",")),l=t[0],a=t.slice(1).map(e=>{let t={};return l.forEach((l,a)=>t[l.trim()]=e[a]?.replace(/"/g,"").trim()),t}).filter(e=>e.Title);if(a.length>0){let e=document.querySelector(".job-list-container");if(e){let t=a.map(e=>`
            ...
            `).join("");e.insertAdjacentHTML("afterbegin",t)}}}catch(e){console.error("Live Sync Failed:",e)}})()},[]),(0,t.jsx)("div",{className:e.bodyClass,style:{margin:0,padding:0},children:(0,t.jsx)("div",{dangerouslySetInnerHTML:{__html:e.body}})})}e.s(["default",()=>a])}]);